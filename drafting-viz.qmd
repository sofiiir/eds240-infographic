...
TO DO: ADD LABELS TO THE GRAPH ABOVE. 
...
Visual 1 challenge: There are very few examples of pictorial stacked barplots. The examples of making the stacked barplots involve making a matrix which is proving extremely difficult.

Visual 2 challenge: My goal is to have more space between the bats and the x-axis. Then there will be an increased amount of space to add the ecosystem labels into that space. I can remove the legend once this is completed. I also want to make my visual navyblue to represent bat the darkness of caves. This iteration of the visual is a noun project visual. I plan to make my own bat visual so that I can change the color an make it either the color of the line or white to stand out on a dark background. 

Visual 3 challenges: Creating spacing that fit the three plots was extremely tedious. I changed the various proportions numerous times to get the desired spacing. I plan to add the title and labels on Affinity to avoid further spacing nightmares hence they are not perfect in this iteration. 
