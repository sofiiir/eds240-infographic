...
The bar plots will be divided into threatened, non-threatened, and data deficient bats. These three sub-divisions do not all have data for all of the different population trends (Increasing, Stable, Decreasing, Unknown). 
