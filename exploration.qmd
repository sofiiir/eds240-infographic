...
```{r}
cave_bats <- st_as_sf(cave_bats, coords = c("longitude", "latitude"), crs = st_crs(4326))
landscape_vul <- st_as_sf(landscape_vul, coords = c("longitude", "latitude"), crs = st_crs(4326))


cave_bats <- st_transform(cave_bats, 3857)
landscape_vul <- st_transform(landscape_vul, 3857)
```
